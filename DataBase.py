...
# Cria uma conexão com o banco de dados SQLite em memória (apagando os dados quando o software fecha)
# engine = create_engine('sqlite:///:memory:', echo=True)
# Cria uma conexão com o banco de dados SQLite em memória (Sem apagar os dados quando o software fecha)
...
class Conta(Base):
    ...
    def __init__(self, saldo=0, limite_saques=3):
        ...
        self.historico = []  # Histórico padrão é uma lista vazia
...
class DataBase():
    ...
    def data_base_realizar_transacao(client_name, conta_id, valor):
